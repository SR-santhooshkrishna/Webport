...
# [Built Portfolio With GitHub ](https://github.com/SR-santhooshkrishna/developer-portfolio-main)
...
### Then, Cust/.;;l,momize data in the `utils/data` [folder](https://github.com/SR-santhooshkrishna/developer-portfolio-main/tree/main/developer-portfolio-main/utils).
...
export const personalData = {
  ...
  description: "My name is Santhooshkrishna Ramesh....",
